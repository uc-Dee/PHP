...
<body>
    <?php
        ...
        // Checking the percentage of the student
        $per = (float)readline("Enter the percentage: "); 
        echo "Entered percentage is: ", $per, "\n"; 
        if($per>=50 && $per<60)
            echo "Grade: D\n\n"; 
        ...
        swapped($name2, $name3); 
        echo("Strings after sorting are: "), $name2, " and ", $name3; 
        

        //  PHP Script for submitting the data
